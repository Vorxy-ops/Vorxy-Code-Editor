class AppConstants {
  ...
  static const Map<String, Map<String, String>> translations = {
    'ru': {
      ...
      'description': 'Мобильная среда разработки для создания и редактирования кода на 10 языках программирования.',
    ...
    'en': {
      ...
      'general': 'General',
      'about_app': 'About',
      'description': 'Mobile development environment for creating and editing code in 10 programming languages.',
